...
const Login = () => {
    ...
    // const user123 = useSelector(state => state.authReducer.user)
    ...
    const signInWithEmail = (e) => {
        ...
        signInWithEmailAndPassword(auth, email, password)
            .then((userCredential) => {
                ...
                loginUser(userCredential.user.toJSON())
            })
            .catch((error) => {
                console.log(error);
        ...
        <div className="mx-auto min-h-screen max-w-[500px]">
            <div className="w-full py-10">
                <div className="w-full flex flex-col gap-3 p-10 items-start ">
                    ...
                    <h3 className='text-xl font-[500]'>Sign Into Your Account</h3>
                    <form className="w-full mt-5" method='post' onSubmit={signInWithEmail}>
                        ...
                        <div className="relative w-full flex flex-col gap-1 ">
                            ...
                            <input
                                ...
                                required={true} />
                            {showPassword ?
                                <svg className='absolute right-2 bottom-2.5 w-[30px] cursor-pointer' xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="2" clip-rule="evenodd" viewBox="0 0 64 64" id="hide" onClick={() => setShowPassword(!showPassword)}>
                                ...
                                <svg className='absolute right-2 bottom-2.5 w-[30px] cursor-pointer' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="eye" onClick={() => setShowPassword(!showPassword)}>
                                    <g data-name="Layer 2">
                                        <g data-name="eye">
                        ...
                        <div className='flex justify-between'>
                            ...
                            <button className="px-3 py-2 text-red-400 rounded-md font-[600]">Forgot Password</button>
                        </div>
                    </form>
                    <br />
                    ...
                    <p className='mx-auto my-5'>Don't have an account? <a href="/signup" className="font-[600] underline underline-offset-2"> Register here</a></p>
                </div>
            </div >
        </div >
    )
